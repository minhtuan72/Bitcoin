	...
	<body>
		<div class="container" style = "height: auto">
			...
			<header class="row">
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light row" style="background-color: #e3f2fd;">
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						...
						<li class="nav-item" role="presentation">
							<a class="nav-link " href="ketqua.php"><i class="fas fa-shopping-basket"></i> Quản lý</a>
						</li>
						<li class="nav-item" role="presentation">
				...
				<div class = "row">
					<div class="container-fluid">
						...
						<form method="post" action="trangchu.php" >
							<h2>Tra cứu tỉ giá tiền ảo</h2>
							<div class="col-sm-6 justify-content-center">
								<div class="form-group ">
									<label for="exampleInputUsername1">Ký hiệu loại tiền muốn tra cứu (BTC, DOGE,...)</label>
									<input type="text" name="username" class="form-control" value="" required/>
								</div>


								<div class="form-group">
									<label for="exampleInputPassword1">Token Api Telegram</label>
									<input type="password" name="apitoken" class="form-control" value="" required/>
								</div>
								<div class="form-group">
									<label for="exampleInputPhone1">Chat Id</label>
									<input type="text" name="chatid" class="form-control" value="" required/>
								</div> 

							</div>


							<input type="submit" name="tracuu" value="Tra cứu" onclick="notify()"/>
							<br>
							<br>
						</div>
						<!-- <script type='text/javascript' src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js'></script>
			...
			<div class = "row" >
				...
				<article class="col-sm-9 form-center">
					<br>
					<br>
